...
namespace Mortezamasumi\FbMars\Tests;
...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        //     fn (string $modelName) => 'Mortezamasumi\\FbMars\\Database\\Factories\\'.class_basename($modelName).'Factory'
        // );
    }
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            FbMarsServiceProvider::class,
            // FbMarsPanelProvider::class,
        ];
    }
}
